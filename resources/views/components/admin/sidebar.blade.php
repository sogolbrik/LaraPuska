    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden py-6 px-4 space-y-8 scrollbar-hide">
        ...
        <div>
            ...
            <nav class="space-y-1.5">
                ...
                <x-admin.sidebar-link href="{{ route('admin.buku.index') }}" :active="request()->routeIs('admin.buku.*')" icon="fa-book-open-reader" label="Katalog Buku" />
                <x-admin.sidebar-link href="{{ route('admin.kategori.index') }}" :active="request()->routeIs('admin.kategori.*')" icon="fa-list" label="Kategori Buku" />
